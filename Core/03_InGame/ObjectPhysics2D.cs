...
namespace PahlUnity
{
    public class ObjectPhysics2D : ObjectPhysicsBase
    {
        ...
        public override Vector3 Velocity { get { return mRB2D.linearVelocity; } set { mRB2D.linearVelocity = value; } }
        public override bool LockGravity { get => mRB2D.gravityScale == 0; set => mRB2D.gravityScale = value ? 0 : mOriGravityScale; }
        public override bool LockMovement { get => mRB2D.bodyType != RigidbodyType2D.Dynamic; set => mRB2D.bodyType = value ? RigidbodyType2D.Kinematic : RigidbodyType2D.Dynamic; }
