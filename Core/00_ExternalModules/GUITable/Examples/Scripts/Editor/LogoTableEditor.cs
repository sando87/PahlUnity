...
public class LogoTableEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		{
			new TableColumn("G", new TableColumnOption(TableColumnOption.Type.Width, 28f)),
			new TableColumn("U", new TableColumnOption(TableColumnOption.Type.Width, 22f)),
			new TableColumn("I     ", new TableColumnOption(TableColumnOption.Type.Width, 35f)),
		};
